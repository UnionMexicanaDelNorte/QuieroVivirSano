...
echo '<section class="content" style="width: calc(100% - 230px); position: fixed; left: 230px;">
    ...
    echo '<div class="FlamaBasic size20 colorNegro  titleWelcome">¡Bienvenido, '.$row_Recordset1['nombre'].'!</div>
            <div class="titleWelcome">
              <p id="cambiaFrase" class="FlamaBasic size18" style="color: #787272;"></p>
            </div>
            <div>
