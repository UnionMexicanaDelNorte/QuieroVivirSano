  ...
  var param = {
    ...
    $.ajax({
      ...
      success : function (resp){
        ...
        {
          myMsgSpinner.dialog('close');
          //cargaHabitoDiaConsecutivo(habito,diaConsecutivo);
      ...
      success : function (resp){
        if(resp.success==1)
        {
          ...
          cad=cad+'<div class="col-md-5">';//termina div 7
            cad=cad+'<br><br><div id="contenedorProgreso"><img src="img/porcentajeProgresoArco.png" width="300px" height="140px"/><img src="img/agujaPorcentajeProgreso.png" width="100px" height="40px"/></div><br><br><br>';//termina div 7
