     ...
     <ol class = "carousel-indicators" style="top: 2%;">\
      ...
      <div class = "carousel-inner" style="padding-bottom:0px;">\
        ...
        <div class = "item" style="width:'+calculando+'px; height:'+ventana_alto+'px;">\
           <img class="imgCT" src = "img/slider/1.jpg">\
        </div>\
        <div class = "item" style="width:'+calculando+'px; height:'+ventana_alto+'px;">\
           <img class="imgCT" src = "img/slider/2.jpg">\
        </div>\
        <div class = "item" style="width:'+calculando+'px; height:'+ventana_alto+'px;">\
           <img class="imgCT" src = "img/slider/3.jpg">\
        </div>\
        <div class = "item" style="width:'+calculando+'px; height:'+ventana_alto+'px;">\
           <img  class="imgCT" src = "img/slider/4.jpg">\
        </div>\
        <div class = "item" style="width:'+calculando+'px; height:'+ventana_alto+'px;">\
           <img  class="imgCT" src = "img/slider/5.jpg">\
        </div>\
        <div class = "item" style="width:'+calculando+'px; height:'+ventana_alto+'px;">\
           <img  class="imgCT" src = "img/slider/6.jpg">\
        </div>\
        <div class = "item" style="width:'+calculando+'px; height:'+ventana_alto+'px;">\
           <img class="imgCT"  src = "img/slider/7.jpg">\
        </div>\
        <div class = "item" style="width:'+calculando+'px; height:'+ventana_alto+'px;">\
           <img class="imgCT"  src = "img/slider/8.jpg">\
        </div>\
     </div>\
